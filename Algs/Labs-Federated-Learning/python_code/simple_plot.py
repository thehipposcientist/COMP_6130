...
acc_fair = pickle.load(open(f"hist/acc/MNIST-iid_FedAvg_FL_5_10_5_5_0.001.pkl", "rb"))
acc_plain = pickle.load(
    open(f"hist/acc/MNIST-iid_FedAvg_plain_1_5_10_5_5_0.001.pkl", "rb")
)
acc_disg = pickle.load(
    open(
        f"hist/acc/MNIST-iid_FedAvg_disguised_1.0_0.001_1_5_10_5_5_0.001_1.pkl",
        "rb",
    )
)

loss_fair = pickle.load(
    open(f"hist/loss/MNIST-iid_FedAvg_FL_5_10_5_5_0.001.pkl", "rb")
)
loss_plain = pickle.load(
    open(f"hist/loss/MNIST-iid_FedAvg_plain_1_5_10_5_5_0.001.pkl", "rb")
)
loss_disg = pickle.load(
    open(
        f"hist/loss/MNIST-iid_FedAvg_disguised_1.0_0.001_1_5_10_5_5_0.001_1.pkl",
        "rb",
    )
)
